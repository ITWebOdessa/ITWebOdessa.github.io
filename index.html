      	...
      	<div class="col-sm-4">
      		<form action="telegram.php" method="POST">
      			...
      			<div class="form-group">
      				...
      				<input type="text" class="form-control" id="" name="user_phone" placeholder="+38 063 63 66 333">
      			</div>
				...
				<div class="form-group">
      				<label for="">Выберите дату заезда</label>
      				<input type="date" class="form-control" id="" name="user_date">
      			</div>
